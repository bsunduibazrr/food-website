...
export const FishAndSeaSection = ({ categories }) => {
  ...
  const handleAddDish = () => {
    ...
    showNotification("New dish is being added to Fish & Sea Foods", "black");
  };
        ...
        <div className="justify-center items-center gap-4 grid grid-cols-4">
          ...
          >
            ...
            <p className="text-[14px] font-medium text-black text-center">
              Add new Dish to <br /> Fish & Sea Food
            </p>
          </div>
