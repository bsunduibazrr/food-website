...
export default function CheffSection({ categories }) {
  ...
  const handleAddDish = () => {
    ...
    showNotification("New dish is being added to Chef's Specials", "black");
  };
        ...
        <div className="justify-center items-center gap-4 grid grid-cols-4">
          ...
          >
            ...
            <p className="text-[14px] font-medium text-black text-center">
              Add new Dish to <br /> Chef's Specials
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg w-[472px] flex flex-col gap-4">
            <div className="flex justify-between">
              <h2 className="text-lg font-semibold">
                Add new Dish to Chef's Specials
              </h2>
              <button
