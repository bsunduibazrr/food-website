...
export const BrunchSection = ({ categories }) => {
  ...
  const handleAddDish = () => {
    ...
    showNotification("New dish is being added to Brunch", "black");
  };
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg w-[472px] flex flex-col gap-4">
            <div className="flex justify-between">
              <h2 className="text-lg font-semibold">Add new Dish to Brunch</h2>
              <button
